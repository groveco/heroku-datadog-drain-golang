...
var fullTests = []struct {
	...
	{
		cnt: 9,
		Req: `452 <134>1 2015-04-07T16:01:43.517062+00:00 host app web.1 - info: responseLogger: metric#tag#path=/parser-page metric#request_id=11747467-f4ce-4b06-8c99-92be968a02e3 metric#request_length=541 metric#response_length=5163 metric#parser_time=5ms metric#eventLoop.count=606 metric#eventLoop.avg_ms=515 metric#eventLoop.p50_ms=0 metric#eventLoop.p95_ms=3457 metric#eventLoop.p99_ms=3457 metric#eventLoop.max_ms=5008`,
		Expected: []string{
