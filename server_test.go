...
var fullTests = []struct {
	...
	},
	{
		...
		Expected: []string{
			"request.length:541|c|#source:web.1,type:web,route:/parser-page",
			"response.length:5163|c|#source:web.1,type:web,route:/parser-page",
			"parser.time:5|c|#source:web.1,type:web,route:/parser-page",
			"eventLoop.count:606|c|#source:web.1,type:web,route:/parser-page",
			"eventLoop.avg.ms:515|c|#source:web.1,type:web,route:/parser-page",
			"eventLoop.p50.ms:0|c|#source:web.1,type:web,route:/parser-page",
			"eventLoop.p95.ms:3457|c|#source:web.1,type:web,route:/parser-page",
			"eventLoop.p99.ms:3457|c|#source:web.1,type:web,route:/parser-page",
			"eventLoop.max.ms:5008|c|#source:web.1,type:web,route:/parser-page",
		},
	},
}
