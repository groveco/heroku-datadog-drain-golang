...
var fullTests = []struct {
	...
	},
	{
		...
		Expected: []string{
			...
			"heroku.dyno.scale:1.000000|g|#type:mailer",
			"heroku.dyno.scale:3.000000|g|#type:web",
		},
	},
	{
		cnt: 1,
	...
	},
	{
		...
		Expected: []string{
			"request.length:541|c|#source:web.1,type:web,path:/parser-page",
			"response.length:5163|c|#source:web.1,type:web,path:/parser-page",
			"parser.time:5|c|#source:web.1,type:web,path:/parser-page",
			"eventLoop.count:606|c|#source:web.1,type:web,path:/parser-page",
			"eventLoop.avg.ms:515|c|#source:web.1,type:web,path:/parser-page",
			"eventLoop.p50.ms:0|c|#source:web.1,type:web,path:/parser-page",
			"eventLoop.p95.ms:3457|c|#source:web.1,type:web,path:/parser-page",
			"eventLoop.p99.ms:3457|c|#source:web.1,type:web,path:/parser-page",
			"eventLoop.max.ms:5008|c|#source:web.1,type:web,path:/parser-page",
		},
	},
}
