...
var fullTests = []struct {
	...
	},
	{
		...
		Expected: []string{
			"request.length:541.000000|g|#source:web.1,type:web,path:/parser-page",
			"response.length:5163.000000|g|#source:web.1,type:web,path:/parser-page",
			"parser.time:5.000000|g|#source:web.1,type:web,path:/parser-page",
			"eventLoop.count:606.000000|g|#source:web.1,type:web,path:/parser-page",
			"eventLoop.avg.ms:515.503300|g|#source:web.1,type:web,path:/parser-page",
			"eventLoop.p50.ms:0.880531|g|#source:web.1,type:web,path:/parser-page",
			"eventLoop.p95.ms:3457.206897|g|#source:web.1,type:web,path:/parser-page",
			"eventLoop.p99.ms:3457.206897|g|#source:web.1,type:web,path:/parser-page",
			"eventLoop.max.ms:5008.000000|g|#source:web.1,type:web,path:/parser-page",
		},
	},
}
