...
229 <45>1 2018-03-03T16:38:15.183130+00:00 host app web.3 - metric#service=100
229 <45>1 2018-03-03T16:38:15.183130+00:00 host app web.3 - metric#tag#name=7_day_remind metric#email.send.processed=1
...
222 <134>1 2015-04-07T16:01:43.517062+00:00 host app api - Release v138 created by user foo@bar`, "\n")
	...
	res = <-s.out
	if res.typ != metricsTag {
		t.Error("result must be METRIC")
	}
